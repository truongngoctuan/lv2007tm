...
{
    public class FourPointLightsEffect : Effect
    {
        ...
        public FourPointLightsEffect(GraphicsDevice device)
            : this(device, "3DPresentation", "Effects/FourPointLightsEffect/FourPointLightsEffect")
        {
        }

        protected FourPointLightsEffect(GraphicsDevice device, string assemblyName, string rootName)
