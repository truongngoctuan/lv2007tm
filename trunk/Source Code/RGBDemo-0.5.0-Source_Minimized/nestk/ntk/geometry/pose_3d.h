...
private:
  ...
  cv::Mat1f setIdentify4()
  {
	  cv::Mat1f temp(4, 4);
	  temp[0][0] = temp[0][1] = temp[0][2] = temp[0][3] = 0;
	  temp[1][0] = temp[1][1] = temp[1][2] = temp[1][3] = 0;
	  temp[2][0] = temp[2][1] = temp[2][2] = temp[2][3] = 0;
	  temp[3][0] = temp[3][1] = temp[3][2] = temp[3][3] = 0;
