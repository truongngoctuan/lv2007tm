...
public:
    ...
    void setupUi(QMainWindow *RawImagesWindow)
    {
        ...
        RawImagesWindow->resize(853, 557);
        ...
        menubar->setGeometry(QRect(0, 0, 853, 18));
        ...
        dockWidget->setMinimumSize(QSize(250, 225));
        ...
        dockWidget_2->setMinimumSize(QSize(250, 225));
    ...
    void retranslateUi(QMainWindow *RawImagesWindow)
    {
        ...
        dockWidget_2->setWindowTitle(QApplication::translate("RawImagesWindow", "Tracked Users", 0, QApplication::UnicodeUTF8));
