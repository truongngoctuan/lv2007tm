...
SET(OpenCV_INCLUDE_DIRS "${THIS_OPENCV_CONFIG_PATH}/include" 
...
# ==============================================================
if(NOT "${THIS_OPENCV_CONFIG_PATH}" STREQUAL  "")
	SET(BASEDIR "${THIS_OPENCV_CONFIG_PATH}")
	foreach(__CVLIB ${OPENCV_LIB_COMPONENTS})
	...
	endforeach(__CVLIB)
endif(NOT "${THIS_OPENCV_CONFIG_PATH}" STREQUAL  "")
...
IF (NOT 1)
    ...
    LINK_DIRECTORIES("${THIS_OPENCV_CONFIG_PATH}/lib" 
                                    "${THIS_OPENCV_CONFIG_PATH}/3rdparty/lib"/../3rdparty/lib)
    if(WIN32)
        LINK_DIRECTORIES("${THIS_OPENCV_CONFIG_PATH}"/3rdparty/lib)
    else()
        LINK_DIRECTORIES("${THIS_OPENCV_CONFIG_PATH}/lib" 
                                    "${THIS_OPENCV_CONFIG_PATH}/3rdparty/lib"/../share/opencv/3rdparty/lib)
    endif()    
