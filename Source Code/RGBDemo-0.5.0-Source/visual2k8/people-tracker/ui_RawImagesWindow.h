...
**
** Created: Fri Jun 17 22:38:02 2011
...
public:
    ...
    void setupUi(QMainWindow *RawImagesWindow)
    {
        ...
        RawImagesWindow->resize(735, 557);
        ...
        actionPeopleTracker = new QAction(RawImagesWindow);
        actionPeopleTracker->setObjectName(QString::fromUtf8("actionPeopleTracker"));
        actionPeopleTracker->setCheckable(true);
        actionPeopleTracker->setChecked(true);
        ...
        depthView = new ntk::ImageWidget(frame_2);
        depthView->setObjectName(QString::fromUtf8("depthView"));
        depthView->setMinimumSize(QSize(320, 240));
        depthView->setFocusPolicy(Qt::ClickFocus);

        horizontalLayout_2->addWidget(depthView);
        ...
        colorView = new ntk::ImageWidget(dockWidgetContents);
        ...
        horizontalLayout_3->addWidget(colorView);
        ...
        integrationTimeText = new QLineEdit(frame);
        integrationTimeText->setObjectName(QString::fromUtf8("integrationTimeText"));
        integrationTimeText->setEnabled(true);
        QSizePolicy sizePolicy3(QSizePolicy::Preferred, QSizePolicy::Fixed);
        sizePolicy3.setHorizontalStretch(0);
        sizePolicy3.setVerticalStretch(0);
        sizePolicy3.setHeightForWidth(integrationTimeText->sizePolicy().hasHeightForWidth());
        integrationTimeText->setSizePolicy(sizePolicy3);
        integrationTimeText->setMinimumSize(QSize(0, 0));
        integrationTimeText->setBaseSize(QSize(0, 0));
        integrationTimeText->setFocusPolicy(Qt::ClickFocus);
        integrationTimeText->setAutoFillBackground(false);
        integrationTimeText->setMaxLength(4);
        integrationTimeText->setFrame(true);
        integrationTimeText->setReadOnly(false);

        horizontalLayout_7->addWidget(integrationTimeText);

        msLabel = new QLabel(frame);
        ...
        menuShow->addAction(actionPeopleTracker);
        menuFile->addAction(action_GrabOneFrame);
    ...
    void retranslateUi(QMainWindow *RawImagesWindow)
    {
        ...
        action_GrabOneFrame->setShortcut(QApplication::translate("RawImagesWindow", "Ctrl+G", 0, QApplication::UnicodeUTF8));
        ...
        actionPeopleTracker->setText(QApplication::translate("RawImagesWindow", "PeopleTracker", 0, QApplication::UnicodeUTF8));
        ...
        dockWidget->setWindowTitle(QApplication::translate("RawImagesWindow", "Color Image", 0, QApplication::UnicodeUTF8));
        ...
        integrationTimeText->setInputMask(QApplication::translate("RawImagesWindow", "0000; ", 0, QApplication::UnicodeUTF8));
        integrationTimeText->setText(QApplication::translate("RawImagesWindow", "1000", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        msLabel->setToolTip(QApplication::translate("RawImagesWindow", "Integration Time", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        msLabel->setText(QApplication::translate("RawImagesWindow", "us (integration)", 0, QApplication::UnicodeUTF8));
