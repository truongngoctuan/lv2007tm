...
{
    public class FourPointLightsTextureEffect : Effect
    {
        ...
        public FourPointLightsTextureEffect(GraphicsDevice device)
            : this(device, "3DPresentation", "Effects/FourPointLightsEffect/FourPointLightsEffect")
        {
        }

        protected FourPointLightsTextureEffect(GraphicsDevice device, string assemblyName, string rootName)
